...
//logs
if ($config['servermode'] == 0){
DEFINE('LOGS_ATCOMMAND', "SELECT SQL_CALC_FOUND_ROWS `atcommandlog`.*, `login`.`group_id` FROM `atcommandlog` JOIN `?`.`login` USING (`account_id`) WHERE `login`.`group_id`<=? ORDER BY `atcommand_date` ASC LIMIT ?, ?");
DEFINE('LOGS_BRANCH', "SELECT SQL_CALC_FOUND_ROWS `branchlog`.*, `login`.`group_id` FROM `branchlog` JOIN `?`.`login` USING (`account_id`) ORDER BY `branch_date` ASC LIMIT ?, ?");
...
DEFINE('LOGS_NPC', "SELECT SQL_CALC_FOUND_ROWS `npclog`.*, `login`.`group_id` FROM `npclog` LEFT JOIN `?`.`login` USING (`account_id`) ORDER BY `npc_date` ASC LIMIT ?, ?");
...
DEFINE('LOGS_ITEMS', "SELECT SQL_CALC_FOUND_ROWS `picklog`.*, `char`.`name` as `char_name`, `login`.`account_id`, `login`.`group_id` FROM `picklog` JOIN `?`.`char` USING (`char_id`) JOIN `?`.`login` ON (`char`.`account_id`=`login`.`account_id`) WHERE `login`.`group_id`<=? ORDER BY `time` ASC LIMIT ?, ?");
...
DEFINE('LOGS_ATCOMMAND', "SELECT SQL_CALC_FOUND_ROWS `atcommandlog`.*, `login`.`level` FROM `atcommandlog` JOIN `?`.`login` USING (`account_id`) WHERE `login`.`level`<=? ORDER BY `atcommand_date` ASC LIMIT ?, ?");
DEFINE('LOGS_BRANCH', "SELECT SQL_CALC_FOUND_ROWS `branchlog`.*, `login`.`level` FROM `branchlog` JOIN `?`.`login` USING (`account_id`) ORDER BY `branch_date` ASC LIMIT ?, ?");
DEFINE('LOGS_LOGIN', "SELECT SQL_CALC_FOUND_ROWS * FROM `loginlog` ORDER BY `time` ASC LIMIT ?, ?");
DEFINE('LOGS_MVP', "SELECT SQL_CALC_FOUND_ROWS * FROM `mvplog` ORDER BY `mvp_date` ASC LIMIT ?, ?");
DEFINE('LOGS_NPC', "SELECT SQL_CALC_FOUND_ROWS `npclog`.*, `login`.`level` FROM `npclog` LEFT JOIN `?`.`login` USING (`account_id`) ORDER BY `npc_date` ASC LIMIT ?, ?");
DEFINE('LOGS_ZENY', "SELECT SQL_CALC_FOUND_ROWS * FROM `zenylog` ORDER BY `time` ASC LIMIT ?, ?");
//DEFINE('LOGS_CASH', "SELECT SQL_CALC_FOUND_ROWS * FROM `cashlog` ORDER BY `time` ASC LIMIT ?, ?");
DEFINE('LOGS_ITEMS', "SELECT SQL_CALC_FOUND_ROWS `picklog`.*, `char`.`name` as `char_name`, `login`.`account_id`, `login`.`level` FROM `picklog` JOIN `?`.`char` USING (`char_id`) JOIN `?`.`login` ON (`char`.`account_id`=`login`.`account_id`) WHERE `login`.`level`<=? ORDER BY `time` ASC LIMIT ?, ?");
