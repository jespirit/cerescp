...
$query = sprintf(LOGS_NPC, $CONFIG_rag_db);
$stmt = prepare_query(LOGS_NPC, 2, 'ii', $inicio, $lpp);
$result = execute_query($stmt, 'lognpc.php');

$stmt = prepare_query(FOUND_ROWS, 2);
$result2 = execute_query(stmt, 'lognpc.php');
